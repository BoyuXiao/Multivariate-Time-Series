...
//     vector<double> lb_mv_double_divide_vector(n2);
...
//     vector<vector<vector<double>>>result_sort4;
//
...
//     vector<double> Q_2dim_0_pca(m);
//     vector<double> Q_2dim_1_pca(m);
...
//                 // mu_sigma(Q1_sort,  mu_Q1_sort, sigma_Q1_sort);
//                 // mu_sigma(Q2_sort,  mu_Q2_sort, sigma_Q2_sort);
//
//                 // if (K1_sort==2) {
...
//                 // sort_sigma_sigma
//                 // result1_sort = Preprocessing_MC3E(Q1_sort, sigma_Q1_sort, sigma_Q2_sort, U_mu_Q1_sort, L_mu_Q1_sort, U_sigma_Q1_sort, L_sigma_Q1_sort,T1_sort,intervalLength_mu1_sort,intervalLength_sigma1_sort,num,r);
//                 //sort_mu_mu_strength
...
//                 //4dim_strength
//                 // result_sort4 = Preprocessing_MC3E_sort_4dim_strength(Test[i],U_mu_Q1_sort,L_mu_Q1_sort,U_sigma_Q1_sort,L_sigma_Q1_sort,U_mu_Q2_sort,L_mu_Q2_sort,U_sigma_Q2_sort,L_sigma_Q2_sort,T1_sort,intervalLength_mu1_sort,intervalLength_sigma1_sort,T2_sort,intervalLength_mu2_sort,intervalLength_sigma2_sort,num,r,split_indices_sort);
//                 result_sort4 = Preprocessing_MC3E_sort_4dim_strength_mumu_sigmasigma(Test[i],U_mu_Q1_sort,L_mu_Q1_sort,U_sigma_Q1_sort,L_sigma_Q1_sort,U_mu_Q2_sort,L_mu_Q2_sort,U_sigma_Q2_sort,L_sigma_Q2_sort,T1_sort,intervalLength_mu1_sort,intervalLength_sigma1_sort,T2_sort,intervalLength_mu2_sort,intervalLength_sigma2_sort,num,r,split_indices_sort);
//
//                 //sigma_4dim_strength
//                 // result_sort4 = Preprocessing_MC3E_sigma_4dim_strength(Test[i],U_mu_Q1_sort,L_mu_Q1_sort,U_sigma_Q1_sort,L_sigma_Q1_sort,U_mu_Q2_sort,L_mu_Q2_sort,U_sigma_Q2_sort,L_sigma_Q2_sort,T1_sort,intervalLength_mu1_sort,intervalLength_sigma1_sort,T2_sort,intervalLength_mu2_sort,intervalLength_sigma2_sort,num,r,split_indices_sort);
//
//                 //pca6---sort4dim_strength
//                 // projection_matrix4 = pca_reduce_with_projection(Test[i],6,Q_pca4,mean_Q4);
//                 // result_sort4 = Preprocessing_MC3E_sort_4dim_strength(Q_pca4,U_mu_Q1_sort,L_mu_Q1_sort,U_sigma_Q1_sort,L_sigma_Q1_sort,U_mu_Q2_sort,L_mu_Q2_sort,U_sigma_Q2_sort,L_sigma_Q2_sort,T1_sort,intervalLength_mu1_sort,intervalLength_sigma1_sort,T2_sort,intervalLength_mu2_sort,intervalLength_sigma2_sort,num,r,split_indices_sort);
//
//             }
//             if (PLUS_COV&&K>=4) {
...
//             // }
//             if (PCA&&K>=2) {
//                 projection_matrix = pca_reduce_with_projection(Test[i],2,Q_pca,mean_Q);
//                 split_two_dim(Q_pca,Q_2dim_0_pca,Q_2dim_1_pca);
//                 result_pca = Preprocessing_MC3E(Q_pca,Q_2dim_0_pca,Q_2dim_1_pca,U_mu_Q_pca,L_mu_Q_pca,U_sigma_Q_pca,L_sigma_Q_pca,T_pca,intervalLength_mu_pca,intervalLength_sigma_pca,num,r);
//             }
//             if (PCA&&K>=4) {
//                 projection_matrix4 = pca_reduce_with_projection(Test[i],4,Q_pca4,mean_Q4);
...
//                     // lb_mv = LB_MV_test(Test[i], Train[j], K, m, r);
//                     // cout<<"lb_mv = "<<lb_mv<<endl;
...
//                     // lb_mc1 = LB_MV_T(new_test, new_train, new_k, new_m, new_r);
//                     // lb_mc1_vector[j] = lb_mc1;
//
//
//                     //debug LB_TI
//                     lb_mc1 = LB_TI(Test[i],Train[j],r,5);
//                     lb_mc1_vector[j] = lb_mc1;
//
//                     // lb_mc1 = calculateLBPCLowerBound(Test[i], Train[j], r, 6, 2);
//                     // lb_mc1_vector[j] = lb_mc1;
//
//                 }
//                 if (MC2) {
...
//                     // }
//                     lb_mc2 = LB_PC(Test[i],Train[j],bboxes);
...
//                 if (MC3E) {
//                     if (K==2) {
//                         lb_mv_double = lb_mv_double(Train[j],U_mu_QE,L_mu_QE,U_sigma_QE,L_sigma_QE,resulte[0],resulte[1],resulte[2],resulte[3],T,intervalLength_muE,intervalLength_sigmaE,num);
//                     }else {
//                         lb_mv_double = lb_mv_double(Train[j],U_mu_QE,L_mu_QE,U_sigma_QE,L_sigma_QE,resulte[0],resulte[1],resulte[2],resulte[3],T,intervalLength_muE,intervalLength_sigmaE,num);
//                     }
//                     lb_mv_double_vector[j] = lb_mv_double;
//                 }
//                 if (PLUS_HALF&&K>=4) {
//                     // if (i==0&&j==11) {
//                     //     cout<<1;
...
//                         lb_mc3_plus_1 = lb_mv_double(A1, U_mu_Q1,L_mu_Q1,U_sigma_Q1,L_sigma_Q1,result1[0],result1[1],result1[2],result1[3],T1,intervalLength_mu1,intervalLength_sigma1,num);
//                     }else {
...
//                         lb_mc3_plus_2 = lb_mv_double(A2, U_mu_Q2,L_mu_Q2,U_sigma_Q2,L_sigma_Q2,result2[0],result2[1],result2[2],result2[3],T2,intervalLength_mu2,intervalLength_sigma2,num);
//                     }else {
...
//                     // lb_mc3_plus_2 = LB_MC_NAIVE2(Q2,A2,mu_Q2,sigma_Q2,K2,m,r);
//
//                     // lb_mc3_plus_1 = lb_mv_double(Q1, A1, mu_Q1,sigma_Q1,U_mu_Q1,L_mu_Q1,U_sigma_Q1,L_sigma_Q1,result1[0],result1[1],result1[2],result1[3],T1,intervalLength_mu1,intervalLength_sigma1,num,K1);
//                     // lb_mc3_plus_2 = lb_mv_double(Q2, A2, mu_Q2,sigma_Q2,U_mu_Q2,L_mu_Q2,U_sigma_Q2,L_sigma_Q2,result2[0],result2[1],result2[2],result2[3],T2,intervalLength_mu2,intervalLength_sigma2,num,K2);
//
...
//                     // mu_sigma(A1_sort,mu_A1_sort,sigma_A1_sort);
//                     // mu_sigma(A2_sort,mu_A2_sort,sigma_A2_sort);
//
//                     //sort_mu_mu
//                     // lb_mc3_plus_sort = lb_mv_double_sort(mu_A1_sort,mu_A2_sort,U_mu_Q1_sort,L_mu_Q1_sort,U_sigma_Q1_sort,L_sigma_Q1_sort,result1_sort[0],result1_sort[1],result1_sort[2],result1_sort[3],T1_sort,intervalLength_mu1_sort,intervalLength_sigma1_sort,num,m,K);
//                     // lb_mc3_plus_sort_vector[j] = lb_mc3_plus_sort;
//
//                     //sort_sigma_sigma
//                     // lb_mc3_plus_sort = lb_mv_double_sort(sigma_A1_sort,sigma_A2_sort,U_mu_Q1_sort,L_mu_Q1_sort,U_sigma_Q1_sort,L_sigma_Q1_sort,result1_sort[0],result1_sort[1],result1_sort[2],result1_sort[3],T1_sort,intervalLength_mu1_sort,intervalLength_sigma1_sort,num,m,K);
//                     // lb_mc3_plus_sort_vector[j] = lb_mc3_plus_sort;
//
//                     //sort_mu_sigma*2
//                     // double lb_mc3_plus_1=0,lb_mc3_plus_2=0;
//                     // lb_mc3_plus_1 = lb_mv_double(A1_sort, U_mu_Q1_sort,L_mu_Q1_sort,U_sigma_Q1_sort,L_sigma_Q1_sort,result1_sort[0],result1_sort[1],result1_sort[2],result1_sort[3],T1_sort,intervalLength_mu1_sort,intervalLength_sigma1_sort,num);
//                     // lb_mc3_plus_2 = lb_mv_double(A2_sort, U_mu_Q2_sort,L_mu_Q2_sort,U_sigma_Q2_sort,L_sigma_Q2_sort,result2_sort[0],result2_sort[1],result2_sort[2],result2_sort[3],T2_sort,intervalLength_mu2_sort,intervalLength_sigma2_sort,num);
//                     // lb_mc3_plus_sort = sqrt(lb_mc3_plus_1*lb_mc3_plus_1+lb_mc3_plus_2*lb_mc3_plus_2);
//                     // lb_mc3_plus_sort_vector[j] = lb_mc3_plus_sort;
//                     // cout<<lb_mc3_plus_sort<<endl;
//                     //strength_mu_mu
//                     // if (i==0&&j==2) {
//                     //     cout<<1;
//                     // }
//                     // lb_mc3_plus_sort = lb_mv_double_sort_strength(Train[j],U_mu_Q1_sort,L_mu_Q1_sort,U_sigma_Q1_sort,L_sigma_Q1_sort,result1_sort[0],result1_sort[1],result1_sort[2],result1_sort[3],T1_sort,intervalLength_mu1_sort,intervalLength_sigma1_sort,num,split_indices_sort);
//                     // lb_mc3_plus_sort_vector[j] = lb_mc3_plus_sort;
//
//                     //4dim_strength
//                     // lb_mc3_plus_sort = lb_mv_double_4dim_sort_strength(Train[j],U_mu_Q1_sort,L_mu_Q1_sort,U_sigma_Q1_sort,L_sigma_Q1_sort,U_mu_Q2_sort,L_mu_Q2_sort,U_sigma_Q2_sort,L_sigma_Q2_sort,result_sort4[0][0],result_sort4[0][1],result_sort4[0][2],result_sort4[0][3],result_sort4[1][0],result_sort4[1][1],result_sort4[1][2],result_sort4[1][3],T1_sort,intervalLength_mu1_sort,intervalLength_sigma1_sort,T2_sort,intervalLength_mu2_sort,intervalLength_sigma2_sort,num,split_indices_sort);
//                     lb_mc3_plus_sort = lb_mv_double_4dim_sort_strength_mumu_sigmasigma(Train[j],U_mu_Q1_sort,L_mu_Q1_sort,U_sigma_Q1_sort,L_sigma_Q1_sort,U_mu_Q2_sort,L_mu_Q2_sort,U_sigma_Q2_sort,L_sigma_Q2_sort,result_sort4[0][0],result_sort4[0][1],result_sort4[0][2],result_sort4[0][3],result_sort4[1][0],result_sort4[1][1],result_sort4[1][2],result_sort4[1][3],T1_sort,intervalLength_mu1_sort,intervalLength_sigma1_sort,T2_sort,intervalLength_mu2_sort,intervalLength_sigma2_sort,num,split_indices_sort);
//                     lb_mc3_plus_sort_vector[j] = lb_mc3_plus_sort;
//
//                     //pca----4dim_strength
//                     // reduce_A_with_Q_projection(Train[j],projection_matrix4,mean_Q4,A_pca4);
//                     // lb_mc3_plus_sort = lb_mv_double_4dim_sort_strength(A_pca4,U_mu_Q1_sort,L_mu_Q1_sort,U_sigma_Q1_sort,L_sigma_Q1_sort,U_mu_Q2_sort,L_mu_Q2_sort,U_sigma_Q2_sort,L_sigma_Q2_sort,result_sort4[0][0],result_sort4[0][1],result_sort4[0][2],result_sort4[0][3],result_sort4[1][0],result_sort4[1][1],result_sort4[1][2],result_sort4[1][3],T1_sort,intervalLength_mu1_sort,intervalLength_sigma1_sort,T2_sort,intervalLength_mu2_sort,intervalLength_sigma2_sort,num,split_indices_sort);
//                     // lb_mc3_plus_sort_vector[j] = lb_mc3_plus_sort;
//
//                     // cout<<lb_mc3_plus_sort<<endl;
//                 }
...
//                     double lb_mc3_plus_1,lb_mc3_plus_2;
//                     if (K1_correlation==2) {
//                         lb_mc3_plus_1 = lb_mv_double(A1_cov,U_mu_Q1_cov,L_mu_Q1_cov,U_sigma_Q1_cov,L_sigma_Q1_cov,result1_cov[0],result1_cov[1],result1_cov[2],result1_cov[3],T1_cov,intervalLength_mu1_cov,intervalLength_sigma1_cov,num);
//                     }else {
//                         lb_mc3_plus_1 = lb_mv_double(A1_cov, U_mu_Q1_cov,L_mu_Q1_cov,U_sigma_Q1_cov,L_sigma_Q1_cov,result1_cov[0],result1_cov[1],result1_cov[2],result1_cov[3],T1_cov,intervalLength_mu1_cov,intervalLength_sigma1_cov,num);
//                     }if (K2_correlation==2) {
//                         lb_mc3_plus_2 = lb_mv_double( A2_cov,U_mu_Q2_cov,L_mu_Q2_cov,U_sigma_Q2_cov,L_sigma_Q2_cov,result2_cov[0],result2_cov[1],result2_cov[2],result2_cov[3],T2_cov,intervalLength_mu2_cov,intervalLength_sigma2_cov,num);
//                     }else {
//                         lb_mc3_plus_2 = lb_mv_double( A2_cov, U_mu_Q2_cov,L_mu_Q2_cov,U_sigma_Q2_cov,L_sigma_Q2_cov,result2_cov[0],result2_cov[1],result2_cov[2],result2_cov[3],T2_cov,intervalLength_mu2_cov,intervalLength_sigma2_cov,num);
//                     }
...
//                     if (K1_sigma==2) {
//                         lb_mc3_plus_1 = lb_mv_double(A1_sigma, U_mu_Q1_sigma,L_mu_Q1_sigma,U_sigma_Q1_sigma,L_sigma_Q1_sigma,result1_sigma[0],result1_sigma[1],result1_sigma[2],result1_sigma[3],T1_sigma,intervalLength_mu1_sigma,intervalLength_sigma1_sigma,num);
//                     }else {
//                         lb_mc3_plus_1 = lb_mv_double(A1_sigma, U_mu_Q1_sigma,L_mu_Q1_sigma,U_sigma_Q1_sigma,L_sigma_Q1_sigma,result1_sigma[0],result1_sigma[1],result1_sigma[2],result1_sigma[3],T1_sigma,intervalLength_mu1_sigma,intervalLength_sigma1_sigma,num);
//                     }
//                     if (K2_sigma==2) {
//                         lb_mc3_plus_2 = lb_mv_double(A2_sigma,U_mu_Q2_sigma,L_mu_Q2_sigma,U_sigma_Q2_sigma,L_sigma_Q2_sigma,result2_sigma[0],result2_sigma[1],result2_sigma[2],result2_sigma[3],T2_sigma,intervalLength_mu2_sigma,intervalLength_sigma2_sigma,num);
//                     }else {
//                         lb_mc3_plus_2 = lb_mv_double(A2_sigma, U_mu_Q2_sigma,L_mu_Q2_sigma,U_sigma_Q2_sigma,L_sigma_Q2_sigma,result2_sigma[0],result2_sigma[1],result2_sigma[2],result2_sigma[3],T2_sigma,intervalLength_mu2_sigma,intervalLength_sigma2_sigma,num);
//                     }
...
//                 }
//                 // if (PCA&&K>=2) {
//                 //     lb_pca = lb_mv_double_2dim_pca(Train[j],U_mu_Q_pca,L_mu_Q_pca,U_sigma_Q_pca,L_sigma_Q_pca,result_pca[0],result_pca[1],result_pca[2],result_pca[3],T_pca,intervalLength_mu_pca,intervalLength_sigma_pca,num,projection_matrix_vector,mean_Q_vector);
//                 //     lb_pca_vector[j] = lb_pca;
//                 // }
//                 // if (PCA4&&K>=4) {
//                 //     lb_pca4 = lb_mv_double_4dim_pca(Train[j],U_mu_Q_pca4_1,L_mu_Q_pca4_1,U_sigma_Q_pca4_1,L_sigma_Q_pca4_1,U_mu_Q_pca4_2,L_mu_Q_pca4_2,U_sigma_Q_pca4_2,L_sigma_Q_pca4_2,result_pca4[0][0],result_pca4[0][1],result_pca4[0][2],result_pca4[0][3],result_pca4[1][0],result_pca4[1][1],result_pca4[1][2],result_pca4[1][3],T_pca4_1,intervalLength_mu_pca4_1,intervalLength_sigma_pca4_1,T_pca4_2,intervalLength_mu_pca4_2,intervalLength_sigma_pca4_2,num,projection_matrix_vector4,mean_Q_vector4);
//                 //     lb_pca4_vector[j] = lb_pca4;
//                 // }
//
//                 if (PCA&&K>=2) {
//                     reduce_A_with_Q_projection(Train[j],projection_matrix,mean_Q,A_pca);
//                     lb_pca = lb_mv_double(A_pca,U_mu_Q_pca,L_mu_Q_pca,U_sigma_Q_pca,L_sigma_Q_pca,result_pca[0],result_pca[1],result_pca[2],result_pca[3],T_pca,intervalLength_mu_pca,intervalLength_sigma_pca,num);
//                     lb_pca_vector[j] = lb_pca;
//                 }
//                 if (PCA4&&K>=4) {
//                     reduce_A_with_Q_projection(Train[j],projection_matrix4,mean_Q4,A_pca4);
...
//                     double lb_mc3_plus_1,lb_mc3_plus_2,lb_mc3_plus_3;
//                     lb_mc3_plus_1 = lb_mv_double(A_pca4_1,U_mu_Q_pca4_1,L_mu_Q_pca4_1,U_sigma_Q_pca4_1,L_sigma_Q_pca4_1,result_pca4_1[0],result_pca4_1[1],result_pca4_1[2],result_pca4_1[3],T_pca4_1,intervalLength_mu_pca4_1,intervalLength_sigma_pca4_1,num);
//                     lb_mc3_plus_2 = lb_mv_double(A_pca4_2,U_mu_Q_pca4_2,L_mu_Q_pca4_2,U_sigma_Q_pca4_2,L_sigma_Q_pca4_2,result_pca4_2[0],result_pca4_2[1],result_pca4_2[2],result_pca4_2[3],T_pca4_2,intervalLength_mu_pca4_2,intervalLength_sigma_pca4_2,num);
//                     // lb_mc3_plus_3 = lb_mv_double(Q_pca4_3,A_pca4_3,Q_2dim_0_pca4_3,Q_2dim_1_pca4_3,U_mu_Q_pca4_3,L_mu_Q_pca4_3,U_sigma_Q_pca4_3,L_sigma_Q_pca4_3,result_pca4_3[0],result_pca4_3[1],result_pca4_3[2],result_pca4_3[3],T_pca4_3,intervalLength_mu_pca4_3,intervalLength_sigma_pca4_3,num,2);
//                     lb_pca4 = sqrt(lb_mc3_plus_1*lb_mc3_plus_1+lb_mc3_plus_2*lb_mc3_plus_2);
//                     lb_pca4_vector[j] = lb_pca4;
//                 }
//
//
...
//                 double dtwDistance = dtw(Train[j], Test[i], K, m, r);
//                 // cout<<dtwDistance<<endl;
//
//                 // cout<<lb_mc1*lb_mc1<<" "<<dtwDistance*dtwDistance<<endl;
//
//                 // if (lb_mv>dtwDistance) {
//                 //     cout<<lb_mv<<" "<<dtwDistance<<endl;
//                 // }
//                 // if (lb_mc1>dtwDistance) {
//                 //     cout<<"mc1 "<<lb_mc1<<" "<<dtwDistance<<endl;
//                 // }
//                 // if (lb_mc2>dtwDistance) {
//                 //     cout<<"mc2 "<<lb_mc2<<" "<<dtwDistance<<endl;
//                 // }
//                 // if (lb_mc3_plus_sort>dtwDistance) {
//                 //     cout<<lb_mc3_plus_sort<<" "<<dtwDistance<<" "<<i<<" "<<j<<endl;
//                 // }
//                 // if (lb_pca>dtwDistance) {
//                 //     cout<<lb_pca<<" "<<i<<" "<<j<<endl;
//                 // }
//                 // if (lb_pca4>dtwDistance) {
//                 //     cout<<lb_pca4<<" "<<i<<" "<<j<<endl;
//                 // }
//                 // if (lb_mv_double>dtwDistance) {
//                 //     cout<<lb_mv_double<<" "<<dtwDistance<<endl;
//                 // }
//
//
//                 //计算pruning_rate
...
//                 if (lb_mv_double_vector[j] > epsilon)count_mc3e+=1;
...
//               for (int j = 0; j < n2; ++j) {
//                   if (K==2) {
//                       lb_mv_double(Train[j],U_mu_QE,L_mu_QE,U_sigma_QE,L_sigma_QE,resulte[0],resulte[1],resulte[2],resulte[3],T,intervalLength_muE,intervalLength_sigmaE,num);
//                   }else {
//                       lb_mv_double(Train[j],U_mu_QE,L_mu_QE,U_sigma_QE,L_sigma_QE,resulte[0],resulte[1],resulte[2],resulte[3],T,intervalLength_muE,intervalLength_sigmaE,num);
//                   }
//               }
//           }
//           end = clock();
//           Time_D_MV = static_cast<double>(end - start) / CLOCKS_PER_SEC;
//       }
//         if (Time_SORT_TEST&&K>=4) {
//             start = clock();
//             for (int i = 0; i < n1; ++i) {
//                 U_mu_Q1_sort.clear(), L_mu_Q1_sort.clear(), U_sigma_Q1_sort.clear(), L_sigma_Q1_sort.clear();
//                 U_mu_Q2_sort.clear(), L_mu_Q2_sort.clear(), U_sigma_Q2_sort.clear(), L_sigma_Q2_sort.clear();
...
//                 result_sort4 = Preprocessing_MC3E_sort_4dim_strength_mumu_sigmasigma(Test[i],U_mu_Q1_sort,L_mu_Q1_sort,U_sigma_Q1_sort,L_sigma_Q1_sort,U_mu_Q2_sort,L_mu_Q2_sort,U_sigma_Q2_sort,L_sigma_Q2_sort,T1_sort,intervalLength_mu1_sort,intervalLength_sigma1_sort,T2_sort,intervalLength_mu2_sort,intervalLength_sigma2_sort,num,r,split_indices_sort);
//                 for (int j = 0; j < n2; ++j) {
//                     lb_mv_double_4dim_sort_strength_mumu_sigmasigma(Train[j],U_mu_Q1_sort,L_mu_Q1_sort,U_sigma_Q1_sort,L_sigma_Q1_sort,U_mu_Q2_sort,L_mu_Q2_sort,U_sigma_Q2_sort,L_sigma_Q2_sort,result_sort4[0][0],result_sort4[0][1],result_sort4[0][2],result_sort4[0][3],result_sort4[1][0],result_sort4[1][1],result_sort4[1][2],result_sort4[1][3],T1_sort,intervalLength_mu1_sort,intervalLength_sigma1_sort,T2_sort,intervalLength_mu2_sort,intervalLength_sigma2_sort,num,split_indices_sort);
//                 }
//             }
//             end = clock();
...
//                     splitA_sort(Train[j],split_indices_cov, A1_cov, A2_cov);
//                     if (K1_correlation==2) {
//                         lb_mv_double(A1_cov,U_mu_Q1_cov,L_mu_Q1_cov,U_sigma_Q1_cov,L_sigma_Q1_cov,result1_cov[0],result1_cov[1],result1_cov[2],result1_cov[3],T1_cov,intervalLength_mu1_cov,intervalLength_sigma1_cov,num);
//                     }else {
//                         lb_mv_double(A1_cov, U_mu_Q1_cov,L_mu_Q1_cov,U_sigma_Q1_cov,L_sigma_Q1_cov,result1_cov[0],result1_cov[1],result1_cov[2],result1_cov[3],T1_cov,intervalLength_mu1_cov,intervalLength_sigma1_cov,num);
//                     }if (K2_correlation==2) {
//                         lb_mv_double( A2_cov,U_mu_Q2_cov,L_mu_Q2_cov,U_sigma_Q2_cov,L_sigma_Q2_cov,result2_cov[0],result2_cov[1],result2_cov[2],result2_cov[3],T2_cov,intervalLength_mu2_cov,intervalLength_sigma2_cov,num);
//                     }else {
//                         lb_mv_double( A2_cov, U_mu_Q2_cov,L_mu_Q2_cov,U_sigma_Q2_cov,L_sigma_Q2_cov,result2_cov[0],result2_cov[1],result2_cov[2],result2_cov[3],T2_cov,intervalLength_mu2_cov,intervalLength_sigma2_cov,num);
//                     }
//             }
...
//                 for (int j = 0; j < n2; ++j) {
//                     reduce_A_with_Q_projection(Train[j],projection_matrix,mean_Q,A_pca);
//                     lb_mv_double(A_pca,U_mu_Q_pca,L_mu_Q_pca,U_sigma_Q_pca,L_sigma_Q_pca,result_pca[0],result_pca[1],result_pca[2],result_pca[3],T_pca,intervalLength_mu_pca,intervalLength_sigma_pca,num);
//                 }
//             }
//             end = clock();
//             Time_PCA = static_cast<double>(end - start) / CLOCKS_PER_SEC;
//         }
//         if (Time_PCA4_TEST&&K>=4) {
//             start = clock();
//             for (int i = 0; i < n1; ++i) {
//                 U_mu_Q_pca4_1.clear(), L_mu_Q_pca4_1.clear(), U_sigma_Q_pca4_1.clear(), L_sigma_Q_pca4_1.clear();
//                 U_mu_Q_pca4_2.clear(), L_mu_Q_pca4_2.clear(), U_sigma_Q_pca4_2.clear(), L_sigma_Q_pca4_2.clear();
...
//                     reduce_A_with_Q_projection(Train[j],projection_matrix4,mean_Q4,A_pca4);
//                     split_half(A_pca4,A_pca4_1,A_pca4_2);
//                     lb_mv_double(A_pca4_1,U_mu_Q_pca4_1,L_mu_Q_pca4_1,U_sigma_Q_pca4_1,L_sigma_Q_pca4_1,result_pca4_1[0],result_pca4_1[1],result_pca4_1[2],result_pca4_1[3],T_pca4_1,intervalLength_mu_pca4_1,intervalLength_sigma_pca4_1,num);
//                     lb_mv_double(A_pca4_2,U_mu_Q_pca4_2,L_mu_Q_pca4_2,U_sigma_Q_pca4_2,L_sigma_Q_pca4_2,result_pca4_2[0],result_pca4_2[1],result_pca4_2[2],result_pca4_2[3],T_pca4_2,intervalLength_mu_pca4_2,intervalLength_sigma_pca4_2,num);
//                 }
//             }
//         end = clock();
//         Time_PCA4 = static_cast<double>(end - start) / CLOCKS_PER_SEC;
//         }
//
//
//
...
void TLB(vector<vector<vector<double>>>& Test, vector<vector<vector<double>>>& Train,string name) {
    ...
    for (int w = 0; w < r_num.size(); w++) {
        ...
        for (int i = 0; i <n1; ++i) {
            ...
            if (MV) {
                // new_test_mv = transpose(Test[i]);
                // new_m_mv = new_test_mv.size();
                // new_k_mv = new_test_mv[0].size();
                // new_r_mv = ceil(r_num[w]*new_k_mv);
            }
            if (MC3E) {
                // new_test_mv = transpose(Test[i]);
                // new_m_mv = new_test_mv.size();
            ...
            for (int j = 0; j < n2; ++j) {
                ...
                if (MV) {
                    ...
                    lb_mv = LB_MV_T(new_test, new_train, new_k, new_m, new_r);
                }
                if (MC3E) {
                    vector<double>lb(m,0);
                    // new_train = transpose(Train[j]);
                    lb_graph = LB_GRAPH(Train[j],Test[i],new_train,new_test,U_mu_QE,L_mu_QE,U_sigma_QE,L_sigma_QE,resulte[0],resulte[1],resulte[2],resulte[3],T,intervalLength_muE,intervalLength_sigmaE,num,lb,r);
                ...
                if (MV_DOUBLE) {
                    // new_train = transpose(Train[j]);
                    lb_mv_double = LB_MV_double_T(new_train,new_test,new_r);
    ...
    if (Time_GRAPH_TEST) {
        ...
        for (int i = 0; i < n1; ++i) {
            ...
            for (int j = 0; j < n2; ++j) {
                vector<double>lb(m,0);
                LB_GRAPH(Train[j],Test[i],new_train,new_test,U_mu_QE,L_mu_QE,U_sigma_QE,L_sigma_QE,resulte[0],resulte[1],resulte[2],resulte[3],T,intervalLength_muE,intervalLength_sigmaE,num,lb,r);
                // LB_GRAPH(Train[j],Test[i],U_mu_QE,L_mu_QE,U_sigma_QE,L_sigma_QE,resulte[0],resulte[1],resulte[2],resulte[3],T,intervalLength_muE,intervalLength_sigmaE,num,lb,r);
            }
        }
        end = clock();
      ...
      if (Time_MC3E_TEST) {
          ...
          for (int i = 0; i < n1; ++i) {
              ...
              for (int j = 0; j < n2; ++j) {
                  start = clock();
                  LB_MV_double_T(new_train,new_test,new_r);
                  end = clock();
                  lb_mv_time += (end - start);
              }
          }
