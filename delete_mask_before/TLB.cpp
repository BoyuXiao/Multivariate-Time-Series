...
//                 if (MC3E) {
//                     if (K==2) {
//                         lb_mc3e = LB_MC3E(Train[j],U_mu_QE,L_mu_QE,U_sigma_QE,L_sigma_QE,resulte[0],resulte[1],resulte[2],resulte[3],T,intervalLength_muE,intervalLength_sigmaE,num);
//                     }else {
//                         lb_mc3e = LB_MC3E(Train[j],U_mu_QE,L_mu_QE,U_sigma_QE,L_sigma_QE,resulte[0],resulte[1],resulte[2],resulte[3],T,intervalLength_muE,intervalLength_sigmaE,num);
//                     }
...
//                         lb_mc3_plus_1 = LB_MC3E(A1, U_mu_Q1,L_mu_Q1,U_sigma_Q1,L_sigma_Q1,result1[0],result1[1],result1[2],result1[3],T1,intervalLength_mu1,intervalLength_sigma1,num);
//                     }else {
...
//                         lb_mc3_plus_2 = LB_MC3E(A2, U_mu_Q2,L_mu_Q2,U_sigma_Q2,L_sigma_Q2,result2[0],result2[1],result2[2],result2[3],T2,intervalLength_mu2,intervalLength_sigma2,num);
//                     }else {
...
//
//                     //sort_sigma_sigma
//                     // lb_mc3_plus_sort = LB_MC3E_sort(sigma_A1_sort,sigma_A2_sort,U_mu_Q1_sort,L_mu_Q1_sort,U_sigma_Q1_sort,L_sigma_Q1_sort,result1_sort[0],result1_sort[1],result1_sort[2],result1_sort[3],T1_sort,intervalLength_mu1_sort,intervalLength_sigma1_sort,num,m,K);
//                     // lb_mc3_plus_sort_vector[j] = lb_mc3_plus_sort;
//
//                     //sort_mu_sigma*2
//                     // double lb_mc3_plus_1=0,lb_mc3_plus_2=0;
//                     // lb_mc3_plus_1 = LB_MC3E(A1_sort, U_mu_Q1_sort,L_mu_Q1_sort,U_sigma_Q1_sort,L_sigma_Q1_sort,result1_sort[0],result1_sort[1],result1_sort[2],result1_sort[3],T1_sort,intervalLength_mu1_sort,intervalLength_sigma1_sort,num);
//                     // lb_mc3_plus_2 = LB_MC3E(A2_sort, U_mu_Q2_sort,L_mu_Q2_sort,U_sigma_Q2_sort,L_sigma_Q2_sort,result2_sort[0],result2_sort[1],result2_sort[2],result2_sort[3],T2_sort,intervalLength_mu2_sort,intervalLength_sigma2_sort,num);
...
//
//                     //4dim_strength
//                     // lb_mc3_plus_sort = LB_MC3E_4dim_sort_strength(Train[j],U_mu_Q1_sort,L_mu_Q1_sort,U_sigma_Q1_sort,L_sigma_Q1_sort,U_mu_Q2_sort,L_mu_Q2_sort,U_sigma_Q2_sort,L_sigma_Q2_sort,result_sort4[0][0],result_sort4[0][1],result_sort4[0][2],result_sort4[0][3],result_sort4[1][0],result_sort4[1][1],result_sort4[1][2],result_sort4[1][3],T1_sort,intervalLength_mu1_sort,intervalLength_sigma1_sort,T2_sort,intervalLength_mu2_sort,intervalLength_sigma2_sort,num,split_indices_sort);
//                     lb_mc3_plus_sort = LB_MC3E_4dim_sort_strength_mumu_sigmasigma(Train[j],U_mu_Q1_sort,L_mu_Q1_sort,U_sigma_Q1_sort,L_sigma_Q1_sort,U_mu_Q2_sort,L_mu_Q2_sort,U_sigma_Q2_sort,L_sigma_Q2_sort,result_sort4[0][0],result_sort4[0][1],result_sort4[0][2],result_sort4[0][3],result_sort4[1][0],result_sort4[1][1],result_sort4[1][2],result_sort4[1][3],T1_sort,intervalLength_mu1_sort,intervalLength_sigma1_sort,T2_sort,intervalLength_mu2_sort,intervalLength_sigma2_sort,num,split_indices_sort);
//                     lb_mc3_plus_sort_vector[j] = lb_mc3_plus_sort;
//
//                     //pca----4dim_strength
//                     // reduce_A_with_Q_projection(Train[j],projection_matrix4,mean_Q4,A_pca4);
//                     // lb_mc3_plus_sort = LB_MC3E_4dim_sort_strength(A_pca4,U_mu_Q1_sort,L_mu_Q1_sort,U_sigma_Q1_sort,L_sigma_Q1_sort,U_mu_Q2_sort,L_mu_Q2_sort,U_sigma_Q2_sort,L_sigma_Q2_sort,result_sort4[0][0],result_sort4[0][1],result_sort4[0][2],result_sort4[0][3],result_sort4[1][0],result_sort4[1][1],result_sort4[1][2],result_sort4[1][3],T1_sort,intervalLength_mu1_sort,intervalLength_sigma1_sort,T2_sort,intervalLength_mu2_sort,intervalLength_sigma2_sort,num,split_indices_sort);
//                     // lb_mc3_plus_sort_vector[j] = lb_mc3_plus_sort;
//
//                     // cout<<lb_mc3_plus_sort<<endl;
//                 }
...
//                     double lb_mc3_plus_1,lb_mc3_plus_2;
//                     if (K1_correlation==2) {
//                         lb_mc3_plus_1 = LB_MC3E(A1_cov,U_mu_Q1_cov,L_mu_Q1_cov,U_sigma_Q1_cov,L_sigma_Q1_cov,result1_cov[0],result1_cov[1],result1_cov[2],result1_cov[3],T1_cov,intervalLength_mu1_cov,intervalLength_sigma1_cov,num);
//                     }else {
//                         lb_mc3_plus_1 = LB_MC3E(A1_cov, U_mu_Q1_cov,L_mu_Q1_cov,U_sigma_Q1_cov,L_sigma_Q1_cov,result1_cov[0],result1_cov[1],result1_cov[2],result1_cov[3],T1_cov,intervalLength_mu1_cov,intervalLength_sigma1_cov,num);
//                     }if (K2_correlation==2) {
//                         lb_mc3_plus_2 = LB_MC3E( A2_cov,U_mu_Q2_cov,L_mu_Q2_cov,U_sigma_Q2_cov,L_sigma_Q2_cov,result2_cov[0],result2_cov[1],result2_cov[2],result2_cov[3],T2_cov,intervalLength_mu2_cov,intervalLength_sigma2_cov,num);
//                     }else {
//                         lb_mc3_plus_2 = LB_MC3E( A2_cov, U_mu_Q2_cov,L_mu_Q2_cov,U_sigma_Q2_cov,L_sigma_Q2_cov,result2_cov[0],result2_cov[1],result2_cov[2],result2_cov[3],T2_cov,intervalLength_mu2_cov,intervalLength_sigma2_cov,num);
//                     }
...
//                     if (K1_sigma==2) {
//                         lb_mc3_plus_1 = LB_MC3E(A1_sigma, U_mu_Q1_sigma,L_mu_Q1_sigma,U_sigma_Q1_sigma,L_sigma_Q1_sigma,result1_sigma[0],result1_sigma[1],result1_sigma[2],result1_sigma[3],T1_sigma,intervalLength_mu1_sigma,intervalLength_sigma1_sigma,num);
//                     }else {
//                         lb_mc3_plus_1 = LB_MC3E(A1_sigma, U_mu_Q1_sigma,L_mu_Q1_sigma,U_sigma_Q1_sigma,L_sigma_Q1_sigma,result1_sigma[0],result1_sigma[1],result1_sigma[2],result1_sigma[3],T1_sigma,intervalLength_mu1_sigma,intervalLength_sigma1_sigma,num);
//                     }
//                     if (K2_sigma==2) {
//                         lb_mc3_plus_2 = LB_MC3E(A2_sigma,U_mu_Q2_sigma,L_mu_Q2_sigma,U_sigma_Q2_sigma,L_sigma_Q2_sigma,result2_sigma[0],result2_sigma[1],result2_sigma[2],result2_sigma[3],T2_sigma,intervalLength_mu2_sigma,intervalLength_sigma2_sigma,num);
//                     }else {
//                         lb_mc3_plus_2 = LB_MC3E(A2_sigma, U_mu_Q2_sigma,L_mu_Q2_sigma,U_sigma_Q2_sigma,L_sigma_Q2_sigma,result2_sigma[0],result2_sigma[1],result2_sigma[2],result2_sigma[3],T2_sigma,intervalLength_mu2_sigma,intervalLength_sigma2_sigma,num);
//                     }
...
//                     lb_pca = LB_MC3E(A_pca,U_mu_Q_pca,L_mu_Q_pca,U_sigma_Q_pca,L_sigma_Q_pca,result_pca[0],result_pca[1],result_pca[2],result_pca[3],T_pca,intervalLength_mu_pca,intervalLength_sigma_pca,num);
//                     lb_pca_vector[j] = lb_pca;
//                 }
//                 if (PCA4&&K>=4) {
//                     reduce_A_with_Q_projection(Train[j],projection_matrix4,mean_Q4,A_pca4);
...
//                     lb_mc3_plus_1 = LB_MC3E(A_pca4_1,U_mu_Q_pca4_1,L_mu_Q_pca4_1,U_sigma_Q_pca4_1,L_sigma_Q_pca4_1,result_pca4_1[0],result_pca4_1[1],result_pca4_1[2],result_pca4_1[3],T_pca4_1,intervalLength_mu_pca4_1,intervalLength_sigma_pca4_1,num);
//                     lb_mc3_plus_2 = LB_MC3E(A_pca4_2,U_mu_Q_pca4_2,L_mu_Q_pca4_2,U_sigma_Q_pca4_2,L_sigma_Q_pca4_2,result_pca4_2[0],result_pca4_2[1],result_pca4_2[2],result_pca4_2[3],T_pca4_2,intervalLength_mu_pca4_2,intervalLength_sigma_pca4_2,num);
//                     // lb_mc3_plus_3 = LB_MC3E(Q_pca4_3,A_pca4_3,Q_2dim_0_pca4_3,Q_2dim_1_pca4_3,U_mu_Q_pca4_3,L_mu_Q_pca4_3,U_sigma_Q_pca4_3,L_sigma_Q_pca4_3,result_pca4_3[0],result_pca4_3[1],result_pca4_3[2],result_pca4_3[3],T_pca4_3,intervalLength_mu_pca4_3,intervalLength_sigma_pca4_3,num,2);
...
//                 // }
//                 // if (lb_mc3e>dtwDistance) {
//                 //     cout<<lb_mc3e<<" "<<dtwDistance<<endl;
//                 // }
//
//
//                 //计算pruning_rate
...
//               for (int j = 0; j < n2; ++j) {
//                   if (K==2) {
//                       LB_MC3E(Train[j],U_mu_QE,L_mu_QE,U_sigma_QE,L_sigma_QE,resulte[0],resulte[1],resulte[2],resulte[3],T,intervalLength_muE,intervalLength_sigmaE,num);
//                   }else {
//                       LB_MC3E(Train[j],U_mu_QE,L_mu_QE,U_sigma_QE,L_sigma_QE,resulte[0],resulte[1],resulte[2],resulte[3],T,intervalLength_muE,intervalLength_sigmaE,num);
//                   }
//               }
...
//                 result_sort4 = Preprocessing_MC3E_sort_4dim_strength_mumu_sigmasigma(Test[i],U_mu_Q1_sort,L_mu_Q1_sort,U_sigma_Q1_sort,L_sigma_Q1_sort,U_mu_Q2_sort,L_mu_Q2_sort,U_sigma_Q2_sort,L_sigma_Q2_sort,T1_sort,intervalLength_mu1_sort,intervalLength_sigma1_sort,T2_sort,intervalLength_mu2_sort,intervalLength_sigma2_sort,num,r,split_indices_sort);
//                 for (int j = 0; j < n2; ++j) {
//                     LB_MC3E_4dim_sort_strength_mumu_sigmasigma(Train[j],U_mu_Q1_sort,L_mu_Q1_sort,U_sigma_Q1_sort,L_sigma_Q1_sort,U_mu_Q2_sort,L_mu_Q2_sort,U_sigma_Q2_sort,L_sigma_Q2_sort,result_sort4[0][0],result_sort4[0][1],result_sort4[0][2],result_sort4[0][3],result_sort4[1][0],result_sort4[1][1],result_sort4[1][2],result_sort4[1][3],T1_sort,intervalLength_mu1_sort,intervalLength_sigma1_sort,T2_sort,intervalLength_mu2_sort,intervalLength_sigma2_sort,num,split_indices_sort);
//                 }
//             }
//             end = clock();
...
//                     splitA_sort(Train[j],split_indices_cov, A1_cov, A2_cov);
//                     if (K1_correlation==2) {
//                         LB_MC3E(A1_cov,U_mu_Q1_cov,L_mu_Q1_cov,U_sigma_Q1_cov,L_sigma_Q1_cov,result1_cov[0],result1_cov[1],result1_cov[2],result1_cov[3],T1_cov,intervalLength_mu1_cov,intervalLength_sigma1_cov,num);
//                     }else {
//                         LB_MC3E(A1_cov, U_mu_Q1_cov,L_mu_Q1_cov,U_sigma_Q1_cov,L_sigma_Q1_cov,result1_cov[0],result1_cov[1],result1_cov[2],result1_cov[3],T1_cov,intervalLength_mu1_cov,intervalLength_sigma1_cov,num);
//                     }if (K2_correlation==2) {
//                         LB_MC3E( A2_cov,U_mu_Q2_cov,L_mu_Q2_cov,U_sigma_Q2_cov,L_sigma_Q2_cov,result2_cov[0],result2_cov[1],result2_cov[2],result2_cov[3],T2_cov,intervalLength_mu2_cov,intervalLength_sigma2_cov,num);
//                     }else {
//                         LB_MC3E( A2_cov, U_mu_Q2_cov,L_mu_Q2_cov,U_sigma_Q2_cov,L_sigma_Q2_cov,result2_cov[0],result2_cov[1],result2_cov[2],result2_cov[3],T2_cov,intervalLength_mu2_cov,intervalLength_sigma2_cov,num);
//                     }
//             }
...
//                 for (int j = 0; j < n2; ++j) {
//                     reduce_A_with_Q_projection(Train[j],projection_matrix,mean_Q,A_pca);
//                     LB_MC3E(A_pca,U_mu_Q_pca,L_mu_Q_pca,U_sigma_Q_pca,L_sigma_Q_pca,result_pca[0],result_pca[1],result_pca[2],result_pca[3],T_pca,intervalLength_mu_pca,intervalLength_sigma_pca,num);
//                 }
//             }
//             end = clock();
...
//                     reduce_A_with_Q_projection(Train[j],projection_matrix4,mean_Q4,A_pca4);
//                     split_half(A_pca4,A_pca4_1,A_pca4_2);
//                     LB_MC3E(A_pca4_1,U_mu_Q_pca4_1,L_mu_Q_pca4_1,U_sigma_Q_pca4_1,L_sigma_Q_pca4_1,result_pca4_1[0],result_pca4_1[1],result_pca4_1[2],result_pca4_1[3],T_pca4_1,intervalLength_mu_pca4_1,intervalLength_sigma_pca4_1,num);
//                     LB_MC3E(A_pca4_2,U_mu_Q_pca4_2,L_mu_Q_pca4_2,U_sigma_Q_pca4_2,L_sigma_Q_pca4_2,result_pca4_2[0],result_pca4_2[1],result_pca4_2[2],result_pca4_2[3],T_pca4_2,intervalLength_mu_pca4_2,intervalLength_sigma_pca4_2,num);
//                 }
//             }
//         end = clock();
        ...
        for (int i = 0; i <n1; ++i) {
            ...
            for (int j = 0; j < n2; ++j) {
                ...
                if (MC3E) {
                    ...
                    lb_mc3e = LB_GRAPH(Train[j],Test[i],U_mu_QE,L_mu_QE,U_sigma_QE,L_sigma_QE,resulte[0],resulte[1],resulte[2],resulte[3],T,intervalLength_muE,intervalLength_sigmaE,num,lb,mask,r);
                }
                if (MV_DOUBLE) {
                    new_train = transpose(Train[j]);
                    // vector<char>mask(new_m,0);
                    // vector<double>lb(new_m,0);
                    // lb_mc3e = LB_MV_double_T(new_train,new_test,new_r);
                    lb_mc3e = LB_TI(Train[j],Test[i],r,5);
                }
                double dtwDistance = dtw(Train[j], Test[i], K, m, r);
                if (lb_mc3e>dtwDistance) {
                    cout<<i<<" "<<j<<" "<<lb_mc3e<<" "<<dtwDistance<<endl;
                }
                if (dtwDistance!=0) {
                    TLB_MV += (lb_mv/dtwDistance);
                    TLB_MC3E += (lb_mc3e/dtwDistance);
      ...
      if (Time_MC3E_TEST) {
          ...
          for (int i = 0; i < n1; ++i) {
              for (int j = 0; j < n2; ++j) {
                  vector<char>mask(m,0);
                  vector<double>lb(m,0);
                  LB_MV_double(Train[j],Test[i],lb,mask,r);
              }
          }
          end = clock();
          Time_MC3E = static_cast<double>(end - start) / CLOCKS_PER_SEC;
