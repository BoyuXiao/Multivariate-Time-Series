...
int main() {
    ...
    for (int i = 0; i < testFilePaths.size(); i++) {
        if (i==5||i==9||i==15||i==19||i==20)continue;
        ...
        if (outputFile.is_open()) {
            outputFile << "Name\tTLB_MV\tTime_MV\tpruning rate_MV\tTLB_MC1\tTime_MC1\tpruning rate_MC1\tTLB_MCNaive1\tTime_MCNaive1\tpruning rate_MCNaive1\tTLB_MC2\tTime_MC2\tpruning rate_MC2\tTLB_MCNaive2\tTime_MCNaive2\tpruning rate_MCnaive\tTLB_MC3\tTime_MC3\tpruning rate_MC3\tTLB_MC3E\tTime_MC3E\tpruning rate_MC3E\tTLB_MC3_PLUS\tTime_MC3_PLUS\tpruning rate_MC3_PLUS\n";
        } else {
