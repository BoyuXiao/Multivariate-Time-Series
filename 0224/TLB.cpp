        ...
        for (int i = 0; i <n1; ++i) {
            ...
            for (int j = 0; j < n2; ++j) {
                ...
                if (PCA&&K>2) {
                    ...
                    lb_pca = LB_MC3E_2dim(Q_pca,A_pca,Q_2dim_0_pca,Q_2dim_1_pca,U_mu_Q_pca,L_mu_Q_pca,U_sigma_Q_pca,L_sigma_Q_pca,result_pca[0],result_pca[1],result_pca[2],result_pca[3],T_pca,intervalLength_mu_pca,intervalLength_sigma_pca,num,K_pca);
                ...
                if (PCA&&K>=6) {
                    ...
                    lb_mc3_plus_1 = LB_MC3E_2dim(Q_pca4_1,A_pca4_1,Q_2dim_0_pca4_1,Q_2dim_1_pca4_1,U_mu_Q_pca4_1,L_mu_Q_pca4_1,U_sigma_Q_pca4_1,L_sigma_Q_pca4_1,result_pca4_1[0],result_pca4_1[1],result_pca4_1[2],result_pca4_1[3],T_pca4_1,intervalLength_mu_pca4_1,intervalLength_sigma_pca4_1,num,2);
                    lb_mc3_plus_2 = LB_MC3E_2dim(Q_pca4_2,A_pca4_2,Q_2dim_0_pca4_2,Q_2dim_1_pca4_2,U_mu_Q_pca4_2,L_mu_Q_pca4_2,U_sigma_Q_pca4_2,L_sigma_Q_pca4_2,result_pca4_2[0],result_pca4_2[1],result_pca4_2[2],result_pca4_2[3],T_pca4_2,intervalLength_mu_pca4_2,intervalLength_sigma_pca4_2,num,2);
                    lb_mc3_plus_3 = LB_MC3E_2dim(Q_pca4_3,A_pca4_3,Q_2dim_0_pca4_3,Q_2dim_1_pca4_3,U_mu_Q_pca4_3,L_mu_Q_pca4_3,U_sigma_Q_pca4_3,L_sigma_Q_pca4_3,result_pca4_3[0],result_pca4_3[1],result_pca4_3[2],result_pca4_3[3],T_pca4_3,intervalLength_mu_pca4_3,intervalLength_sigma_pca4_3,num,2);
                    lb_pca4 = sqrt(lb_mc3_plus_1*lb_mc3_plus_1+lb_mc3_plus_2*lb_mc3_plus_2+lb_mc3_plus_3*lb_mc3_plus_3);
