...
// double lbPetitjean_new(std::vector<double>& p, const std::vector<double>& q, std::vector<double>& up, std::vector<double>& lp,
//                      const std::vector<double>& uq, const std::vector<double>& lq, const std::vector<double>& x,
//                      const std::vector<double>& ux, const std::vector<double>& lx, int w,
//                      double &lbk2, double miu, double si) {
//
//     double d = lbk2;
//     int l_index = 0;
//     int u_index = 0;
